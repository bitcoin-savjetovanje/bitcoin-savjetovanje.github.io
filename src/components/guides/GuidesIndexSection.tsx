  ...
  return (
    <section id="vodici" className="section-shell section-muted">
      <SectionHeader
        ...
        copy="Ako želite razumjeti okvir, čitajte vodiče. Ako ga želite primijeniti na vlastiti proračun, dug, darivanje, Bitcoin, neto imovinu i obitelj, dogovorite provjeru."
        align="center"
      />
      <GuideCardsGrid />
