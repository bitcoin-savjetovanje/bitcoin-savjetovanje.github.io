...
export function TopicHero({
  ...
  return (
    <section className={classNames} data-topic-theme={theme}>
      <div className="topic-hero-v2__copy">
        <p className="topic-hero-v2__eyebrow">{eyebrow}</p>
        <h1 className="topic-hero-v2__title">{title}</h1>
        <p className="topic-hero-v2__lead">{lead}</p>
        <p className="topic-hero-v2__body">{body}</p>
        <div className="topic-hero-v2__actions">
          {actions.map((action) => {
      ...
      <figure className="topic-hero-v2__media">
        <picture>
          {image.webpSrc ? (
