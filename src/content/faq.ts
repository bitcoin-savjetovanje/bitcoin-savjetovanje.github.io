export const faqs = [
  {
    ...
    answer:
      "Ne. Ne dajem licencirani investicijski, porezni ni pravni savjet. Ne govorim što će cijena napraviti i ne preuzimam odluku. Radimo na pravilima po kojima donosimo bolje odluke.",
  },
  {
