...
function loadRouteComponents() {
  routeComponentsPromise ??= Promise.all([
    ...
    import("@/pages/SamplePersonalBitcoinStandard"),
    import("@/pages/BitcoinStandardCheck"),
    ...
    ([
      ...
      SamplePersonalBitcoinStandard:
        samplePersonalBitcoinStandard.SamplePersonalBitcoinStandard,
      BitcoinStandardCheck: bitcoinStandardCheck.BitcoinStandardCheck,
